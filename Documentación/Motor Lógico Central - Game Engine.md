Aquí tienes el **Motor Lógico Central (Game Engine)** para FactoWar.

Este código integra rigurosamente las variables: CRA, Piso Estructural, Tags, Power-Ups, SEIZ. Es el cerebro del simulador. Está escrito en JavaScript (ES6) limpio y comentado para ser implementado.

---

### 📂 Archivo: `src/logic/gameEngine.js`
