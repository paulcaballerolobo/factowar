...
### Zona: Canvas (HUD)
*   **Reloj:** `TEMPO DE RED:`
*   **Salud de Red:** `INTEGRIDAD DEL SISTEMA`
*   **Día:** `DÍA [01] / 30`
...
1.  **"SISTEMA ONLINE. ESPERANDO SELECCIÓN DE AMENAZA..."**
2.  **"ALERTA: PICO DE #INDIGNACIÓN DETECTADO EN SECTOR NEUTRO."**
3.  **"ADVERTENCIA: CONTENIDO #CALIENTE VIRALIZANDO A ALTA VELOCIDAD."**
4.  **"PELIGRO: FORMACIÓN DE CÁMARAS DE ECO. RUPTURA DEL DIÁLOGO."**
5.  **"BOLETÍN: VERIFICACIÓN OFICIAL PUBLICADA. INICIANDO RECUPERACIÓN."**
6.  **"FALLO CRÍTICO DEL SISTEMA. LA RED HA COLAPSADO."**
